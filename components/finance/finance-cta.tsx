          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                asChild
                size="lg"
                className="rounded-full bg-emerald-500 px-8 py-6 text-base font-bold text-white shadow-[0_4px_28px_rgba(16,185,129,0.45)] ring-2 ring-emerald-300/40 hover:bg-emerald-400"
              >
